...
if [ "$1" = "all" ] ; then
    benchmarks="sqlite-3.33.0 gawk-5.1.0 gcal-4.1 find-4.7.0 grep-3.6 diff-3.7 du-8.32 make-4.3 patch-2.7.6 ptx-8.32 expr-8.32 csplit-8.32 ls-8.32 trueprint-5.4 combine-0.4.0 sed-4.8"
else
    benchmarks=$@
fi
